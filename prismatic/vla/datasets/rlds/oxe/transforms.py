...
def finetune_task_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    #  最后一维的最小值: -3570.0
    # 最后一维的最大值: 63210.0
    # gripper_min, gripper_max = -3570.0, 63210.0
    # gripper_action = (trajectory["action"][:, -1:] - gripper_min) / (gripper_max - gripper_min)
    # gripper_action = tf.clip_by_value(gripper_action, 0.0, 1.0)
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
...
def finetune_task_transform_eef(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    #  最后一维的最小值: -3570.0
    # 最后一维的最大值: 63210.0
    # gripper_min, gripper_max = -3570.0, 63210.0
    # gripper_action = (trajectory["action"][:, -1:] - gripper_min) / (gripper_max - gripper_min)
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    ### Finetune tasks
    "finetune_task": finetune_task_transform,
    "finetune_task04": finetune_task_transform,
    "finetune_task05": finetune_task_transform,
    "finetune_task06": finetune_task_transform,
    "finetune_task07": finetune_task_transform,
    ### Finetune tasks with EEF state
    "finetune_task_EEF": finetune_task_transform_eef,
    "finetune_task_eef01": finetune_task_transform_eef,

    ## Finetune tasks including validation set
    "finetune_task_val": finetune_task_transform,
}
